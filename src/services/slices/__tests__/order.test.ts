...
import orderSlice, { TInitialState } from '../ordersSlice';
import { orders, orderBurger } from '@thunks';

describe('Jest test orderSlice', () => {
  ...
  it('should done Orders action', async () => {
    const actionPending = {
  ...
  it('should done orderBurger action', async () => {
    const actionPending = {
